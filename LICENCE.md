The Vide0Link source repository is governed by the GNU AFFERO GENERAL PUBLIC LICENSE. (AGPL-3.0)
That AGPL-3.0 licence can be found here: [AGPLv3.md](https://github.com/steveseguin/vdo.ninja/blob/master/AGPLv3.md)

In essence, Vide0Link is open-source and free to use, both for commercial and non-commercial use.
...
Contributors to the Vide0Link project must first agree to the Contributor License Agreement (CLA).
