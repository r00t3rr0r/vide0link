...
This directory contains various examples demonstrating different features and capabilities of Vide0Link. All examples are accessible through the index.html file.
...
- **iframe.outbound-stats.html** - Get stats from Vide0Link using the iframe API
...
- **dual.html** - Two Vide0Link windows (Picture-in-Picture style)
...
### Control Examples
- **obsremote.html** - Remotely control OBS using Vide0Link
...
- **twitch.html** - Twitch live chat side-by-side with Vide0Link
- **youtube.html** - YouTube integration example
- **kick.html** - Kick platform integration
- **wireless.html** - Wireless streaming setup
- **zoom.html** - Publish to Vide0Link for window-capturing into Zoom
...
- Examples may require specific Vide0Link features or permissions
