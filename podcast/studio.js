...
function buildRoomGate(defaults = {}) {
  ...
  const cancelButton = createElement('button', 'podcast-room-gate__cancel', {
    ...
    title: 'Return to the classic Vide0Link interface.',
  });
...
class PodcastStudioApp {
  ...
  readIcecastConfigFromForm() {
    ...
    return {
      ...
      metadata: {
        name: storedSettings.name || 'Vide0Link Live',
  ...
  buildLayout() {
    ...
    icecastBody.append(
      createIcecastField('Source URL', this.icecastTargetInput, 'Recommended: allow Vide0Link in the Icecast/AzuraCast CORS settings for the best direct publishing path.'),
    ...
    footer.innerHTML = `
      <div>Powered by Vide0Link • Low-latency P2P backbone intact • <span class="podcast-help-link" id="podcast-help-link" role="button" tabindex="0">Guide</span></div>
    ...
    const sections = [
      ...
      },
      {
        ...
        content: `
          ...
          <ul>
            ...
            <li>Files appear in a "Vide0Link Recordings" folder</li>
          </ul>
      ...
      },
      {
        ...
        content: `
          ...
          <p>The studio video ISO mode is still memory-heavy because files finalize after stop. For the most resilient long-form runs, guests can still use <code>&record</code> in their URL or the remote recording features in the classic Vide0Link interface.</p>
        `,
      },
      {
      ...
      },
      {
        title: 'Live Captions',
        content: `
          <p>Vide0Link supports real-time speech-to-text captions:</p>
          <ul>
