Welcome to the translation / language section of crypt.c0mm.l1nk
...
There is a file called translate.js, which if you copy/paste the content (and hit enter) into the Chrome browser's console, while on crypt.c0mm.l1nk, it will download the translation files.
...
the "blank.json" file contains a minimal template.  Little to no crypt.c0mm.l1nk branding.
